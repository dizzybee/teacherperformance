  ...
  <div class="blog-list-row">
    <div class="blog-list-content">
      <div class="blog-list-header">
        <div class="left-side">
          <img src="<?php print $directory; ?>/images/blog-play.png"/>
        </div>
    ...
    <div class="blog-list-date">
      ...
      <div class="blog-list-body">
        ...
        <div class="blog-list-text">
          ...
          <a href="<?php print $fields['path']->content; ?>" alt="View Blog Post"><img src="<?php print $directory; ?>/images/blog-list-view-button.png"/></a>
        </div>
      </div>
